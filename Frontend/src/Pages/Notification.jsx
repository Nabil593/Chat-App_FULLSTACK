...
import { BellIcon, Clock1Icon, ClockIcon, MessageSquare, MessageSquareIcon, UserCheckIcon } from "lucide-react";
import Button from "@mui/material/Button";
import NoNotificayionsFound from "../components/NoNotificayionsFound";
                    ...
                    <div className="card-body p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm my-1">{notifications.recipient.fullname}
