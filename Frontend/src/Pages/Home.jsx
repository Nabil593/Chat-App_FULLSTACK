...
import { getOutgoingFriendsReqs, getRecommendedUsers, getUserFriends, sendFriendsRequest } from '../config/api';
import { Link } from 'react-router';
import { CheckCircleIcon, MapPinIcon, User, UserPlusIcon } from "lucide-react";
    ...
    <div className='p-4 sm:p-6 lg:p-8 space-y-8'>
      <div className='container mx-auto '>
        ...
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
          ...
          <User className='size-4'/>Friend Request
          </Link>
        </div>

        {loadingFriends ? (
          <div className='flex justify-center py-12'>
            <span className='loading koading-spinner loading-lg'></span>
          </div>
        ) : friends.length === 0 ? (
          <NoFriendFound/>
        ) : (
