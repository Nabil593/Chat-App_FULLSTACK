    ...
    <div className='dropdown dropdown-end'>
      ...
      <div className='space-y-1'>
        {THEMES.map((themeOption) => (
          <button key={themeOption.name} className={`w-full px-4 py-3 rounded-l-lg flex items-center gap-3 transition-colors ${
